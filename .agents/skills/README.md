...
| `sp-plan` | `writing-plans` | Bite-sized tasks (2–5 min) with exact file paths, complete code, verification steps. | "write a plan", "break this into tasks", "implement X" |
...
- **`docs/HANDBOOK.md` §5** in `cubecloud-desktop/` — the master-handbook section that ties the 34-skill ecosystem to the desktop's product surface.
