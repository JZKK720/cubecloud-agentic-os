"""
prepare.py — One-time data preparation for autoresearch experiments.
...
NOTE: This file is read-only during the autoresearch loop. Only train.py
may be modified by the agent.
"""
...
@torch.no_grad()
def evaluate_bpb(model, tokenizer, batch_size: int) -> float:
    """
