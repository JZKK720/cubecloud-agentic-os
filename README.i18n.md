...
| README (binary) | English | `agent-desktop/README.md` | **Live, V2.10.48 full preview gallery refresh** (header banner, download card, onboarding captures, and full surface screenshot grid) | Cubecloud Contributors |
| README (binary) | 日本語(ja-JP) | `agent-desktop/README.ja-JP.md` | **Live, V2.10.48 full preview gallery refresh** (header / install / 22-surface gallery refreshed; native-speaker review still welcome) | Cubecloud Contributors + Community |
| README (binary) | 简体中文(zh-CN) | `agent-desktop/README.zh-CN.md` | **Live, V2.10.48 full preview gallery refresh** (header / install / 22-surface gallery refreshed; native-speaker review still welcome) | Cubecloud Contributors + Community |
| README (binary) | 한국어(ko-KR) | `agent-desktop/README.ko-KR.md` | **Live, V2.10.48** (machine-translated starting point with the same header, install banner, and 22-surface gallery as the other binary READMEs; native-speaker review welcome) | Cubecloud Contributors + Community |
