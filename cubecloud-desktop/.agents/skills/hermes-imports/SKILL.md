---
name: hermes-imports
description: How to keep cubecloud-desktop in sync with hermes-agent, hermes-cli, and the upstream open-source projects. When to rebase, when to vendor, when to fork.
source: ecc
metadata:
...
- `cubecloud-desktop` (this repo) — the Electron UI.
