...
# Then remove %APPDATA%\cubecloud-desktop and %LOCALAPPDATA%\cubecloud-desktop.
...
### From upstream `hermes-desktop` to `cubecloud-desktop`
...
2. Install `cubecloud-desktop` over the upstream install.
