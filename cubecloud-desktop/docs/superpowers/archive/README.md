...
These files were moved here from `cubecloud-desktop/docs/superpowers/plans/`
and `cubecloud-desktop/docs/superpowers/specs/` respectively in V2.10.36.
The two now-empty `plans/` and `specs/` subdirs were removed.

## Do not add new files here

New release designs should land in `cubecloud-desktop/docs/superpowers/plans/`
and `cubecloud-desktop/docs/superpowers/specs/` if a future V2.10.x
