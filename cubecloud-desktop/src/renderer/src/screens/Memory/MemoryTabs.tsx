import { Database, User, Cloud, Sparkles, BookOpen, Lightbulb } from "lucide-react";
...
export function MemoryTabs({ activeTab, onTabChange }: MemoryTabsProps): React.JSX.Element {
  ...
  const tabs: { id: MemoryTab; icon: typeof Database; label: string }[] = [
    ...
    { id: "wiki", icon: BookOpen, label: t("memory.wikiTab") },
    { id: "learnings", icon: Lightbulb, label: t("memory.learningsTab") },
