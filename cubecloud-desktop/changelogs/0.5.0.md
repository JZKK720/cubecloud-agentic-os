...
- **[@leejamesss](https://github.com/leejamesss)** — in-app OAuth sign-in for subscription providers (PR #102)
- **[@jason-edstrom](https://github.com/jason-edstrom)** — tool calls, tool output & reasoning in chat history (PR #327)
