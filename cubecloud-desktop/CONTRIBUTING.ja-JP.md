> **Cubecloud Agent Desktop — デスクトップ版バイナリ向けのコントリビューションポリシー。**
> モノレポ全体の DCO 1.1 ポリシーは [`../CONTRIBUTING.md`](../CONTRIBUTING.md) をご覧ください。
> ライセンス / ブランド / スキルエコシステムの説明は [`../BRANDING_AND_LICENSE.md`](../BRANDING_AND_LICENSE.md) と [`../.agents/skills/README.md`](../.agents/skills/README.md) をご覧ください。


# Agent Desktop へのコントリビューション

Agent Desktop へのコントリビューションに興味を持っていただきありがとうございます！バグ修正、新機能、ドキュメント改善、ちょっとしたタイポ修正まで、どんな貢献も歓迎します。
...
バグを見つけた場合は、以下の情報を添えて [Issue を作成してください](https://github.com/cubecloud-contributors/cubecloud-agentic-os/issues/new)。
...
アイデアがある場合は、[Issue を作成して](https://github.com/cubecloud-contributors/cubecloud-agentic-os/issues/new)以下を記述してください。
...
- Cubecloud のコミュニティ導線はリブランド移行中です。現在はリポジトリの Issue を利用してください。
- 現在のランタイム挙動については、Cubecloud 専用ドキュメントが整うまで [Hermes Agent のドキュメント](https://hermes-agent.nousresearch.com/docs/) を参照してください。
