...
const ZH_LINES = [
  ...
  '\u684c\u9762\u7aef\u4e8c\u8fdb\u5236\u6587\u4ef6\u4f4d\u4e8e [`cubecloud-desktop/`](cubecloud-desktop/)\uff08\u4ea4\u4ed8\u7ed9\u7ec8\u7aef\u7528\u6237\u7684\u5b8c\u6574 Electron \u5e94\u7528\uff09\uff1b',
  ...
  '\u8fd9\u4e09\u9879\u627f\u8bfa\u5e26\u51fa\u4e09\u4e2a\u968f\u4e4b\u800c\u6765\u7684\u540e\u679c\uff1a',
  '',
  '- \u4e00\u4e2a**\u5e7f\u9614\u7684 IPC \u8868\u9762**\uff08`cubecloud-desktop/src/main/`\u3001`cubecloud-desktop/src/preload/`\uff09\u5411\u6e32\u67d3\u8fdb\u7a0b\u66b4\u9732\u4e86\u8fd0\u884c\u65f6\u3001\u6a21\u578b\u6ce8\u518c\u8868\u3001\u63d0\u4f9b\u8005\u6ce8\u518c\u8868\u3001\u6280\u80fd\u6e47\u8868\u3001\u8bb0\u5fc6\u5e73\u9762\u3001\u5b9a\u65f6\u4efb\u52a1\u8c03\u5ea6\u5668\u4e0e\u7f51\u5173\u5c42\u3002\u8be5\u8868\u9762\u662f\u96c6\u6210\u8fb9\u754c\uff0c\u4e5f\u662f\u6c89\u7ee7\u6846\u67b6\u4ee3\u7801\u4e2d\u6700\u5927\u7684\u90e8\u5206\u3002',
  ...
  '- **\u8fd0\u884c\u65f6\u7f16\u6392**\uff08[`cubecloud-desktop/src/main/hermes-runtime/`](cubecloud-desktop/src/main/hermes-runtime/)\u3001`.../openclaw/`\u3001`.../ironclaw/`\uff09\u2014\u2014\u591a\u8fd0\u884c\u65f6\u9009\u62e9\u5668\u3002\u6bcf\u4e2a\u8fd0\u884c\u65f6\u90fd\u6709\u63a2\u6d4b / \u5b89\u88c5 / \u914d\u7f6e / \u4ee3\u7406\u6d41\u7a0b\uff1b\u7528\u6237\u4ece\u8fd0\u884c\u65f6\u9009\u62e9\u5668\u4e2d\u9009\u62e9\uff0c\u800c\u4e0d\u662f\u4ece CLI \u53c2\u6570\u9009\u62e9\u3002',
  ...
  '- **\u6280\u80fd\u5e26\u5b50**\uff08[`cubecloud-desktop/src/main/skills-harness.ts`](cubecloud-desktop/src/main/skills-harness.ts)\uff09\u2014\u2014agent \u8fd0\u884c\u65f6\u7684\u6280\u80fd\u5c42\uff0c\u542b `HIDDEN_SKILLS[]` \u4f5c\u4e3a\u98ce\u683c\uff08\u8bed\u6c14\u3001\u6210\u672c\u3001\u8bb8\u53ef\uff09\uff0c\u5305\u88f9\u6bcf\u4e2a\u51fa\u53e3\u8bf7\u6c42\u3002',
  '- **CodeGraph \u9762**\uff08[`cubecloud-desktop/src/main/codegraph-runtime.ts`](cubecloud-desktop/src/main/codegraph-runtime.ts)\uff09\u2014\u2014CodeGraph \u5c4f\u5e55\u4e24\u4e2a\u540e\u7aef\uff1a\u4e00\u4e2a CLI \u5b50\u8fdb\u7a0b\uff08\u6c89\u7ee7\uff09\u4e0e\u4e00\u4e2a\u5185\u5d4c SDK \u5305\u88c5\uff08Cubecloud \u539f\u521b\uff09\u3002\u53c2\u89c1 [`docs/CODEGRAPH-RUNTIME.md`](docs/CODEGRAPH-RUNTIME.md)\u3002',
  '- **EverOS \u8f85\u52a9\u8fdb\u7a0b**\uff08[`cubecloud-desktop/src/main/everos-sidecar.ts`](cubecloud-desktop/src/main/everos-sidecar.ts)\uff09\u2014\u2014\u53ef\u9009 `everos server start` Python \u8f85\u52a9\u8fdb\u7a0b\u7684\u751f\u547d\u5468\u671f\u7ba1\u7406\u5668\u3002\u9884\u542f\u52a8\u5305\u4e2d\u7684 3 \u4e2a\u9ed8\u8ba4\u7981\u7528\u7684\u5e26\u5b50\uff08`cubecloud-memory-distill`\u3001`cubecloud-cost-watchdog`\u3001`cubecloud-skill-audit`\uff09\u4e3a\u7528\u6237\u53ef\u89c1\u9762\u3002\u53c2\u89c1 [`docs/EVEROS-SIDECAR.md`](docs/EVEROS-SIDECAR.md)\u3002',
  '',
  ...
  '- **\u4f60\u662f\u8bc4\u4f30\u684c\u9762\u7aef\u7684\u4e0b\u6e38\u7528\u6237**\u3002\u8bf7\u9605\u8bfb [`docs/HANDBOOK.md`](docs/HANDBOOK.md) ' + SECTION_SIGN + '1 \u2192 ' + SECTION_SIGN + '3.1\uff0c\u7136\u540e ' + SECTION_SIGN + '10\uff08\u8bb8\u53ef / \u54c1\u724c\uff09\u4ee5\u4e86\u89e3\u5bf9\u4e8c\u8fdb\u5236\u6587\u4ef6\u4f60\u80fd\u505a\u4ec0\u4e48\u3001\u4e0d\u80fd\u505a\u4ec0\u4e48\u3002\u684c\u9762\u7aef\u7684\u5b89\u88c5 + \u529f\u80fd\u8bf4\u660e\u4f4d\u4e8e [`cubecloud-desktop/README.md`](cubecloud-desktop/README.md)\u3002',
  ...
  '\u251c\u2500\u2500 cubecloud-desktop/            \u5b8c\u6574\u7684 Electron \u4e8c\u8fdb\u5236\u6587\u4ef6\uff08408 \u4e2a\u6587\u4ef6\uff0c14.8 MB\uff09',
  ...
  '',
  '\u63cf\u8ff0**\u4e8c\u8fdb\u5236\u6587\u4ef6**\uff08`cubecloud-desktop/README.md`\u3001`CONTRIBUTING.md`\uff09\u7684\u8bd1\u6587\u4f4d\u4e8e',
  '`cubecloud-desktop/README.<lang>.md` \u4e0e `CONTRIBUTING.<lang>.md`\uff1b',
