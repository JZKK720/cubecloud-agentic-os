...
- [`.agents/skills/`](.agents/skills/) には7つのアップストリームリポジトリから適応された34の第一級オープンソーススキルが含まれ、`~/.agents/skills/` にミラーリングされます。
...
- **バージョン管理された方法論。** 34スキルエコシステムは文書化され、来歴が追跡され、アップストリームのスキルプロセスから継承されたred-baseline規律によって支えられています。
...
├── .agents/                      ~/.agents/skills/ にミラーリングされる34のオープンソーススキル
