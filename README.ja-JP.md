...
デスクトップバイナリは [`cubecloud-desktop/`](cubecloud-desktop/) にあります。
...
- [`cubecloud-desktop/`](cubecloud-desktop/) はエンドユーザーに提供される完全なElectronデスクトップです。
...
- **スキルハーネス** - [`cubecloud-desktop/src/main/skills-harness.ts`](cubecloud-desktop/src/main/skills-harness.ts) が送信リクエストの周囲にスキルレイヤーを適用。
...
- **デスクトップを評価する読者：** 最初に [`cubecloud-desktop/README.md`](cubecloud-desktop/README.md) を読み、次に [`docs/HANDBOOK.md`](docs/HANDBOOK.md) のセクション1、3、10を読んでください。
