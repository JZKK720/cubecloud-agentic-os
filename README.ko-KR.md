...
데스크톱 바이너리는 [`cubecloud-desktop/`](cubecloud-desktop/)에 있습니다.
...
- [`cubecloud-desktop/`](cubecloud-desktop/)은 최종 사용자에게 제공되는 완전한 Electron 데스크톱입니다.
...
- **스킬 하네스** - [`cubecloud-desktop/src/main/skills-harness.ts`](cubecloud-desktop/src/main/skills-harness.ts)가 발신 요청 주위에 스킬 레이어를 적용.
...
- **데스크톱 평가자:** 먼저 [`cubecloud-desktop/README.md`](cubecloud-desktop/README.md)를 읽은 후 [`docs/HANDBOOK.md`](docs/HANDBOOK.md) 섹션 1, 3, 10을 읽으세요.
