...
感谢你愿意为 Agent Desktop 做出贡献。无论是修复 bug、添加新功能、完善文档，还是修正一个拼写错误，每一份贡献都很有价值。
...
如果你发现了 bug，请在 GitHub 上 [提交 issue](https://github.com/cubecloud-contributors/cubecloud-agentic-os/issues/new)，并尽量包含：
...
如果你有新想法，也欢迎 [提交 issue](https://github.com/cubecloud-contributors/cubecloud-agentic-os/issues/new)，并描述：
...
- Cubecloud 社区入口仍在重整中，目前请先使用仓库 Issue 进行沟通。
- 在 Cubecloud 专用文档完善前，请先参考 [Hermes Agent 文档](https://hermes-agent.nousresearch.com/docs/) 了解当前运行时行为。
