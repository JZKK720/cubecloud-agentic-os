...
export const PROVIDERS = {
  ...
  options: [
    ...
    { value: "volcano", label: "ByteDance Volcano" },
  ...
  setup: [
    ...
    },
    {
      id: "stepfun",
      name: "StepFun",
      desc: "Hosted Step model inference",
      tag: "API Key",
    ...
    },
    {
      ...
      desc: "Hosted Doubao models from ByteDance Volcano Engine",
      tag: "API Key",
      envKey: "VOLCANO_API_KEY",
      url: "https://www.volcengine.com/product/ark",
      placeholder: "...",
      configProvider: "volcano",
