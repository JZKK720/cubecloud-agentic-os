export default {
  ...
  approval: {
    title: "Se requiere aprobación de herramienta",
    hint: "El agente quiere ejecutar una herramienta que necesita tu aprobación. Revisa cada solicitud y apruébala o recházala.",
