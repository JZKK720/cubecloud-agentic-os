export default {
  ...
  firecrawlHint: "Búsqueda, extracción y rastreo web (capa sin clave disponible)",
  firecrawlApiUrl: "URL de la API de Firecrawl",
  firecrawlUrlHint: "URL de instancia autoalojada (opcional, para despliegues local-first)",
