export default {
  ...
  lanePickerHint:
    "Estas s鉶 pistas de gateway direto. {{ironclaw}} 茅 distribu铆do como um runtime de cont锚iner, n鉶 como um gateway direto; use a transfer锚ncia do Docker Desktop abaixo para anexar.",
