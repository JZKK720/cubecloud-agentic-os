export default {
  ...
  firecrawlHint: "Pesquisa web, extração e rastreamento (camada sem chave disponível)",
  firecrawlApiUrl: "URL da API Firecrawl",
  firecrawlUrlHint: "URL de instância auto-hospedada (opcional, para implantações local-first)",
