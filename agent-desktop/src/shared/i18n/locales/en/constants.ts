export default {
  ...
  firecrawlHint: "Web search, extract, and crawl (keyless tier available)",
  firecrawlApiUrl: "Firecrawl API URL",
  firecrawlUrlHint: "Self-hosted instance URL (optional, for local-first deployments)",
  falKey: "FAL.ai Key",
  ...
  browserHarnessApiKey: "Browser Use API Key",
  browserHarnessHint: "Cloud browsers for browser-harness (local CDP also works)",
  browserHarnessCdpUrl: "CDP URL (optional)",
  browserHarnessCdpHint: "e.g. http://127.0.0.1:9222 for local Chrome",
  browserHarnessDomainSkills: "Domain Skills (optional)",
  browserHarnessDomainHint: "Set to 1 to enable site-specific skills",
