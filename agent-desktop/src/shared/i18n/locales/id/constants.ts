export default {
  ...
  firecrawlHint: "Pencarian, ekstraksi, dan crawl web (tanpa API key untuk penggunaan dasar)",
  firecrawlApiUrl: "Firecrawl API URL",
  firecrawlUrlHint: "URL instansi self-hosted (opsional, untuk deployment local-first)",
  falKey: "FAL.ai Key",
