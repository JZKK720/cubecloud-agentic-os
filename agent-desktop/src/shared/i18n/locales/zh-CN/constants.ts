export default {
  ...
  firecrawlHint: "网页搜索、提取和爬取（提供免费无密钥额度）",
  firecrawlApiUrl: "Firecrawl API URL",
  firecrawlUrlHint: "自托管实例地址（可选，适用于本地优先部署）",
  falKey: "FAL.ai Key",
  ...
  browserHarnessHint: "browser-harness 云端浏览器（本地 CDP 也可用）",
  browserHarnessCdpUrl: "CDP URL（可选）",
  browserHarnessCdpHint: "例如 http://127.0.0.1:9222 用于本地 Chrome",
  browserHarnessDomainSkills: "领域技能（可选）",
  browserHarnessDomainHint: "设为 1 启用站点特定技能",
