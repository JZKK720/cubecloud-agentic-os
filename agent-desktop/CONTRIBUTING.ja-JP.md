...
バグを見つけた場合は、以下の情報を添えて [Issue を作成してください](https://github.com/JZKK720/cubecloud-agentic-os/issues/new)。
...
アイデアがある場合は、[Issue を作成して](https://github.com/JZKK720/cubecloud-agentic-os/issues/new)以下を記述してください。
