...
`http://<vps>:3000`. Tighter integration is tracked in upstream desktop issue
#196.
...
Tracked in upstream desktop issue #182. If you hit this, store the desktop's API key
...
Related upstream tracker references: issues #159, #182, #195 and PRs #204, #205.
