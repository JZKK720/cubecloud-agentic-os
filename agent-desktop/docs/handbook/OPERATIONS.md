...
> **Companion to the master handbook (`docs/HANDBOOK.md` Â§6, Â§9, Â§11).** This is the long-form operations guide. The handbook gives you the one-screen summary; this gives you the 30-screen walkthrough for the on-call operator.
...
`docs/legal/CUBECLOUD-EULA.md` is the EULA for the hosted-service path. Operators who want to run a Cubecloud-derivative service without the AGPL-3.0 Â§13 network-source obligation can use the commercial-relicensing path in `docs/legal/COMMERCIAL_LICENSE.md`.
...
[`docs/RETIRED_AND_LEGACY.md`](../RETIRED_AND_LEGACY.md) Â§
