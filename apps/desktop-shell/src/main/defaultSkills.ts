...
//
// Cubecloud-original pre-launch defaults — Skills tab.
//
...
//   cubecloud-desktop/docs/HANDBOOK.md §"5.3 Adding a pre-installed skill"
...
export const DEFAULT_SKILLS: AgentSkill[] = [
  {
    ...
    description:
      ...
      "or behaviour — invokes the default Cubecloud operator persona " +
  ...
  },
  {
    ...
    category: "workflow",
    description:
      "Use when the user is in their first 5 minutes with the desktop — " +
  ...
  },
  {
    ...
    description:
      ...
      "function, or what the impact of a change is — wraps the existing " +
