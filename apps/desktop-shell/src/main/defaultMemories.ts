...
//
// Cubecloud-original pre-launch defaults โ€?Memory tab.
//
...
//   agent-desktop/BRANDING_AND_LICENSE.md ยง"V2.9 transitions landed"
//   agent-desktop/docs/HANDBOOK.md ยง"5.3 Adding a pre-installed memory"
//   .agents/skills/README.md (the developer-time skill index)

import type { AgentMemoryEntry } from "@cubecloud/platform-core";

/**
 * Pre-installed memory entries. These are *seeds* โ€?not
